...
while ($operation) {
    ...
    elseif ($choice -eq 9) {
        ...
        Write-Host ""
        Write-Host "Checking for users with more than 10 failed logins..."
        Write-Host ""
        ...
        foreach ($log in $failedLogins) {
            ...
            if ($count -gt 10) {
                Write-Host "$user has $count failed logins in the last $days days."
            }
        ...
        Write-Host ""
        Write-Host "Done checking failed logins."
    }
